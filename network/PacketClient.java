...
public class PacketClient implements IPacketHandler{
	...
	public static final void recieve(Packet250CustomPayload packet, EntityPlayer player, NetworkManager manager)
	{
		...
		try
		{
			...
			switch(ID)
			{
			case 1: (new PacketParticleSpawn()).interpret(stream, new Object[] {world}, Side.CLIENT); break;
			default: CompactMobsCore.instance.cmLog.info("Unknown packet type recived"); break;
			}
