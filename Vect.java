...
public class Vect
{
  ...
  public Vect multiply(float factor) {
    Vect result = new Vect(this.x, this.y, this.z);
    Vect tmp21_20 = result; tmp21_20.x = (int)(tmp21_20.x * factor);
    Vect tmp33_32 = result; tmp33_32.y = (int)(tmp33_32.y * factor);
    Vect tmp45_44 = result; tmp45_44.z = (int)(tmp45_44.z * factor);
    return result;
  }
