...
public class BlockExaminer extends BlockContainer {
	
    public BlockExaminer(int par1, Material par2Material) {
    ...
    public void registerIcons(IconRegister register) {
    	sideTex = register.registerIcon("compactMobs:ExaminerSide");
    	topTex = register.registerIcon("compactMobs:ExaminerTop");
    	bottomTex = register.registerIcon("compactMobs:ExaminerBottom");
    	topTexFull=register.registerIcon("compactMobs:ExaminerTopFull");
    }
